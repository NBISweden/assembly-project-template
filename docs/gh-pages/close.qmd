...
- [ ] Raw data is in `data/raw-data`.
- [ ] Analysis results are in `data/intermediates`.
- [ ] Frozen/Finialized results are in `data/finalized`.
- [ ] The roadmap in `analyses/Roadmap.md` is upto date with the relationship between analyses.
