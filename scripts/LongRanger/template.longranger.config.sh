...
TENX_PATH="/projects/dazzlerAssembly/asm_{{PROJECT_ID}}/data/10x/"
QC_DATA_DIR="/projects/dazzlerAssembly/asm_{{PROJECT_ID}}/processed-data/10x/LongRanger"
QV_REFFASTA=
QV_OUTDIR=/projects/dazzlerAssembly/asm_{{PROJECT_ID}}/assembly/Scaff10X
QV_RUNID=1
